...
RUN --mount=type=cache,target=/var/cache/apt,sharing=locked \
    ...
    --mount=type=bind,source=apt.strace,target=/apt.strace \
    apt-get update && \
    apt-get install --no-install-recommends -y git g++ python3 python-is-python3
