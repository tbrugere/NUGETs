...
class Polyhedron_3_Halfedge_handle(object):
    ...
    def __init__(self, *args):
        _CGAL_Polyhedron_3.Polyhedron_3_Halfedge_handle_swiginit(self, _CGAL_Polyhedron_3.new_Polyhedron_3_Halfedge_handle(*args))
...
class Polyhedron_3_Edge_handle(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _CGAL_Polyhedron_3.Polyhedron_3_Edge_handle_swiginit(self, _CGAL_Polyhedron_3.new_Polyhedron_3_Edge_handle(*args))

    def halfedge(self, *args):
        return _CGAL_Polyhedron_3.Polyhedron_3_Edge_handle_halfedge(self, *args)

    def deepcopy(self, *args):
        return _CGAL_Polyhedron_3.Polyhedron_3_Edge_handle_deepcopy(self, *args)
    __swig_destroy__ = _CGAL_Polyhedron_3.delete_Polyhedron_3_Edge_handle

# Register Polyhedron_3_Edge_handle in _CGAL_Polyhedron_3:
_CGAL_Polyhedron_3.Polyhedron_3_Edge_handle_swigregister(Polyhedron_3_Edge_handle)
