...
class Point_and_Polyhedron_3_Edge_handle(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _CGAL_AABB_tree.Point_and_Polyhedron_3_Edge_handle_swiginit(self, _CGAL_AABB_tree.new_Point_and_Polyhedron_3_Edge_handle(*args))
    first = property(_CGAL_AABB_tree.Point_and_Polyhedron_3_Edge_handle_first_get, _CGAL_AABB_tree.Point_and_Polyhedron_3_Edge_handle_first_set)
    second = property(_CGAL_AABB_tree.Point_and_Polyhedron_3_Edge_handle_second_get, _CGAL_AABB_tree.Point_and_Polyhedron_3_Edge_handle_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _CGAL_AABB_tree.delete_Point_and_Polyhedron_3_Edge_handle

# Register Point_and_Polyhedron_3_Edge_handle in _CGAL_AABB_tree:
_CGAL_AABB_tree.Point_and_Polyhedron_3_Edge_handle_swigregister(Point_and_Polyhedron_3_Edge_handle)
...
class Object_and_Polyhedron_3_Edge_handle(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _CGAL_AABB_tree.Object_and_Polyhedron_3_Edge_handle_swiginit(self, _CGAL_AABB_tree.new_Object_and_Polyhedron_3_Edge_handle(*args))
    first = property(_CGAL_AABB_tree.Object_and_Polyhedron_3_Edge_handle_first_get, _CGAL_AABB_tree.Object_and_Polyhedron_3_Edge_handle_first_set)
    second = property(_CGAL_AABB_tree.Object_and_Polyhedron_3_Edge_handle_second_get, _CGAL_AABB_tree.Object_and_Polyhedron_3_Edge_handle_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _CGAL_AABB_tree.delete_Object_and_Polyhedron_3_Edge_handle

# Register Object_and_Polyhedron_3_Edge_handle in _CGAL_AABB_tree:
_CGAL_AABB_tree.Object_and_Polyhedron_3_Edge_handle_swigregister(Object_and_Polyhedron_3_Edge_handle)
...
class Optional_Polyhedron_3_Edge_handle(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _CGAL_AABB_tree.Optional_Polyhedron_3_Edge_handle_swiginit(self, _CGAL_AABB_tree.new_Optional_Polyhedron_3_Edge_handle())

    def empty(self):
        return _CGAL_AABB_tree.Optional_Polyhedron_3_Edge_handle_empty(self)

    def value(self):
        return _CGAL_AABB_tree.Optional_Polyhedron_3_Edge_handle_value(self)

    def deepcopy(self, *args):
        return _CGAL_AABB_tree.Optional_Polyhedron_3_Edge_handle_deepcopy(self, *args)
    __swig_destroy__ = _CGAL_AABB_tree.delete_Optional_Polyhedron_3_Edge_handle

# Register Optional_Polyhedron_3_Edge_handle in _CGAL_AABB_tree:
_CGAL_AABB_tree.Optional_Polyhedron_3_Edge_handle_swigregister(Optional_Polyhedron_3_Edge_handle)
...
class Optional_Object_and_Polyhedron_3_Edge_handle(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _CGAL_AABB_tree.Optional_Object_and_Polyhedron_3_Edge_handle_swiginit(self, _CGAL_AABB_tree.new_Optional_Object_and_Polyhedron_3_Edge_handle())

    def empty(self):
        return _CGAL_AABB_tree.Optional_Object_and_Polyhedron_3_Edge_handle_empty(self)

    def value(self):
        return _CGAL_AABB_tree.Optional_Object_and_Polyhedron_3_Edge_handle_value(self)

    def deepcopy(self, *args):
        return _CGAL_AABB_tree.Optional_Object_and_Polyhedron_3_Edge_handle_deepcopy(self, *args)
    __swig_destroy__ = _CGAL_AABB_tree.delete_Optional_Object_and_Polyhedron_3_Edge_handle

# Register Optional_Object_and_Polyhedron_3_Edge_handle in _CGAL_AABB_tree:
_CGAL_AABB_tree.Optional_Object_and_Polyhedron_3_Edge_handle_swigregister(Optional_Object_and_Polyhedron_3_Edge_handle)
...
class AABB_tree_Polyhedron_3_Edge_handle(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_swiginit(self, _CGAL_AABB_tree.new_AABB_tree_Polyhedron_3_Edge_handle(*args))

    def rebuild(self, range):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_rebuild(self, range)

    def clear(self):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_clear(self)

    def size(self):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_size(self)

    def empty(self):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_empty(self)

    def do_intersect(self, *args):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_do_intersect(self, *args)

    def number_of_intersected_primitives(self, *args):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_number_of_intersected_primitives(self, *args)

    def all_intersected_primitives(self, *args):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_all_intersected_primitives(self, *args)

    def any_intersected_primitive(self, *args):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_any_intersected_primitive(self, *args)

    def any_intersection(self, *args):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_any_intersection(self, *args)

    def all_intersections(self, *args):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_all_intersections(self, *args)

    def squared_distance(self, *args):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_squared_distance(self, *args)

    def closest_point(self, *args):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_closest_point(self, *args)

    def closest_point_and_primitive(self, *args):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_closest_point_and_primitive(self, *args)

    def accelerate_distance_queries(self, *args):
        return _CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_accelerate_distance_queries(self, *args)
    __swig_destroy__ = _CGAL_AABB_tree.delete_AABB_tree_Polyhedron_3_Edge_handle

# Register AABB_tree_Polyhedron_3_Edge_handle in _CGAL_AABB_tree:
_CGAL_AABB_tree.AABB_tree_Polyhedron_3_Edge_handle_swigregister(AABB_tree_Polyhedron_3_Edge_handle)
